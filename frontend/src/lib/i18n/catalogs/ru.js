export default {
  ...
  'settings.section.pluginsHint': 'установка, включение, отключение, разрешения',
  'settings.search': 'Поиск по настройкам',
  'settings.noMatches': 'Ничего не найдено',
  'settings.pluginsDescription': 'Установка, включение и отключение плагинов, а также их разрешения.',
  'settings.openPluginManager': 'Открыть менеджер плагинов',
  'settings.section.diagnostics': 'Диагностика',
  'settings.section.diagnosticsHint': 'журнал, лог, падение, отчёт, ошибка, поддержка',
  'settings.diagnosticsDescription': 'Отчёт о том, что это за сборка, какие плагины загрузились и что записано в логе. Содержимое vault, секреты и ключ синхронизации в него не попадают.',
  'settings.diagnosticsLog': 'Лог этого запуска',
  'settings.diagnosticsNoLog': 'Этот запуск лог не пишет.',
  'settings.collectDiagnostics': 'Сохранить отчёт',
  'settings.diagnosticsSaved': 'Сохранено: {path}',
  'build.label': 'Версия Верстака: {version}',
  'build.commit': 'Ревизия: {commit}',
  'build.date': 'Собрано: {date}',
  'statusBar.label': 'Строка состояния',
  'vault.none': 'Хранилище не открыто',
  'vault.noneHint': 'Откройте или создайте хранилище, чтобы начать работу',
  'vault.unnamed': 'Хранилище',
  'vault.tooltip': 'Папка хранилища: {path}',
  ...
  'workspace.createFirst': 'Создать Дело',
  ...
  'workspaceTree.rename': 'Переименовать',
  'workspaceTree.renameFolder': 'Переименовать папку',
  'workspaceTree.renameDeal': 'Переименовать Дело',
  'workspaceTree.editDeal': 'Редактировать Дело',
  'workspaceTree.editDealLoadError': 'Не удалось загрузить настройки Дела.',
  'workspaceTree.editDealSaveError': 'Не удалось сохранить настройки Дела.',
  'workspaceTree.moveFolder': 'Переместить папку',
  'workspaceTree.moveDeal': 'Переместить Дело',
  ...
  'workspaceTree.customTemplateName': 'Произвольный',
  'workspaceTree.customTemplateDescription': 'Начните без выбранных инструментов и отметьте нужные для этого Дела.',
  'workspaceTree.tools': 'Инструменты Дела',
  ...
  'workspaceTree.name': 'Название',
  'workspaceTree.folderName': 'Название папки',
  'workspaceTree.namePlaceholder': 'Название Дела',
  'workspaceTree.folderNamePlaceholder': 'Название папки',
  'workspaceTree.newName': 'Новое название',
  'workspaceTree.newLocation': 'Новое расположение',
  'workspaceTree.root': 'Корень вольта',
  'workspaceTree.open': 'Открыть',
  'workspaceTree.move': 'Переместить',
  'workspaceTree.toTrash': 'В Корзину',
  'workspaceTree.trashFolder': 'Переместить папку в Корзину',
  'workspaceTree.trashDeal': 'Переместить Дело в Корзину',
  'workspaceTree.trashFolderDesc': 'Всё поддерево будет перемещено в Корзину.',
  'workspaceTree.trashDealDesc': 'Файлы и данные Дела будут перемещены в Корзину и смогут быть восстановлены.',
  'workspaceTree.contains': 'Содержит',
  'workspaceTree.nestedFolders': 'вложенные папки',
  'workspaceTree.emptyTitle': 'Дел пока нет',
  'workspaceTree.emptyHint': 'Создайте первое Дело или папку.',
