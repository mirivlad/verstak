export default {
  ...
  'settings.section.pluginsHint': 'install, enable, disable, permissions',
  'settings.search': 'Search settings',
  'settings.noMatches': 'No setting matches that search',
  'settings.pluginsDescription': 'Install, enable and disable plugins, and review what each one is allowed to do.',
  'settings.openPluginManager': 'Open Plugin Manager',
  'settings.section.diagnostics': 'Diagnostics',
  'settings.section.diagnosticsHint': 'log, crash, report, bug, support',
  'settings.diagnosticsDescription': 'A report of what this build is, which plugins loaded and what the log says. It never includes the contents of your vault, your secrets or your sync key.',
  'settings.diagnosticsLog': 'Session log',
  'settings.diagnosticsNoLog': 'This run is not writing a log.',
  'settings.collectDiagnostics': 'Save a report',
  'settings.diagnosticsSaved': 'Saved to {path}',
  'build.label': 'Verstak version: {version}',
  'build.commit': 'Revision: {commit}',
  'build.date': 'Built: {date}',
  'statusBar.label': 'Status bar',
  'vault.none': 'No vault open',
  'vault.noneHint': 'Open or create a vault to start working',
  'vault.unnamed': 'Vault',
  'vault.tooltip': 'Vault folder: {path}',
  'sidebar.tools': 'Tools',
  ...
  'workspace.createFirst': 'Create a Deal',
  ...
  'workspaceTree.renameFolder': 'Rename folder',
  'workspaceTree.renameDeal': 'Rename Deal',
  'workspaceTree.editDeal': 'Edit Deal',
  'workspaceTree.editDealLoadError': 'Could not load Deal settings.',
  'workspaceTree.editDealSaveError': 'Could not save Deal settings.',
  'workspaceTree.moveFolder': 'Move folder',
  'workspaceTree.moveDeal': 'Move Deal',
  ...
  'workspaceTree.customTemplateName': 'Custom',
  'workspaceTree.customTemplateDescription': 'Start with no tools selected and choose the ones this Deal needs.',
  'workspaceTree.tools': 'Deal tools',
  ...
  'workspaceTree.name': 'Name',
  'workspaceTree.folderName': 'Folder name',
  'workspaceTree.folderNamePlaceholder': 'Folder name',
  'workspaceTree.newName': 'New name',
  'workspaceTree.newLocation': 'New location',
  'workspaceTree.root': 'Vault root',
  'workspaceTree.open': 'Open',
  'workspaceTree.move': 'Move',
  'workspaceTree.toTrash': 'Move to Trash',
  'workspaceTree.trashFolder': 'Move folder to Trash',
  'workspaceTree.trashDeal': 'Move Deal to Trash',
  'workspaceTree.trashFolderDesc': 'The entire subtree will be moved to Trash.',
  'workspaceTree.trashDealDesc': 'The Deal files and data will be moved to Trash and can be restored.',
  'workspaceTree.contains': 'Contains',
  'workspaceTree.nestedFolders': 'nested folders',
  'workspaceTree.emptyTitle': 'No Deals yet',
  'workspaceTree.emptyHint': 'Create your first Deal or folder.',
